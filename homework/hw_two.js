...
console.log('__ 2 вариант решения task 1 __');
...
console.log('__ 2 вариант решения task 2 __');
...
const removeArray = (usersClub, list) => {
    return usersClub.filter(current => {
...
const mapReal = (newRelease) => {
    return newRelease.map(({ id, title }) => {
        return ({ id, title })
    })
}
